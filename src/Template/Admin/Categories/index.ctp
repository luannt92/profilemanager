                ...
                <div class="ibox-content">
                    ...
                    <table class="footable table table-stripped toggle-arrow-tiny">
                        ...
                        <tr>
                            ...
                            <th data-toggle="true"><?php echo $this->Paginator->sort('position') ?></th>
                            <th scope="col"><?php echo $this->Paginator->sort('slug') ?></th>
                            <th scope="col"><?php echo $this->Paginator->sort('service_id') ?></th>
                        ...
                        <?php foreach ($items as $item):
                            ...
                            <tr>
                                ...
                                <td><?php echo !empty($item->service->name) ? h($item->service->name) : '' ?></td>
                                <td>
